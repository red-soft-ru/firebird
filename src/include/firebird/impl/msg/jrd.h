...
FB_IMPL_MSG(JRD, 960, jret_non_scalar, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 961, jret_more_than_one, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 962, jret_missing_wrapper_scalar, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 963, jret_missing_wrapper_several, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 964, jdyn_type_invalid_token, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 965, jdyn_type_unknown_token, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 966, jdyn_double_func_invalid_token, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 967, jdyn_double_func_parsing_error, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 968, jpath_invalid_filter_result, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 969, jpath_number_parsing_err, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 970, jpath_incorrect_statement, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 971, jpath_calculation_err, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 972, jpath_to_double_convent_err, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 973, jpath_unknown_type, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 974, jpath_array_too_big, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 975, jpath_invalid_syntax, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 976, jpath_recursive_filter, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 977, jpath_missing_accessor, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 978, jpath_missing_start_token, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 979, jpath_wildcard_in_name, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 980, jpath_quote_in_name, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 981, jpath_illegal_name, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 982, jpath_illegal_symbol, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 983, jpath_illegal_wildcard, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 984, jpath_unexpected_end, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 985, jpath_wrong_compairing_operand, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 986, jpath_unexpected_element, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 987, jprsr_unexpected_state, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 988, jprsr_invalid_syntax, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 989, jprsr_iunsup_seq, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 990, jis_unescaped_character, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 991, jis_incorrect_code, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 992, jis_double_high_surrogate, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 993, jis_missing_high_surrogate, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 994, jus_incorrect_code, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 995, jus_unsupported_encoding, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 996, jis_invalid_sequence, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 997, jis_invalid_token, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 1000, jis_string_end_expected, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 1001, jis_input_end_expected, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 1002, jis_value_expected, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 1003, jis_string_expected, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 1004, jis_array_element_expected, -901, "22", "000", "")
FB_IMPL_MSG(JRD, 1005, jis_range_symbol_expected, -901, "22", "000", "")
