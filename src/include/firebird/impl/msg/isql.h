...
FB_IMPL_MSG_SYMBOL(ISQL, 197, NO_TABLESPACE, "There is no tablespace @1 in this database")
FB_IMPL_MSG_SYMBOL(ISQL, 198, NO_TABLESPACES, "There are no tablespaces in this database")
FB_IMPL_MSG_SYMBOL(ISQL, 199, MSG_TABLESPACES, "Tablespaces:")
