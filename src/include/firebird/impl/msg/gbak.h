...
FB_IMPL_MSG_NO_SYMBOL(GBAK, 406, "writing tablespaces")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 407, "writing tablespace @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 408, "restoring tablespace @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 409, "tablespace")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 410, "    @1TS_MAP(PING_FILE) <mapping file>         mapping file for tablespaces")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 411, "path to tablespace @1 is not specified (original path: \"@2\")")
