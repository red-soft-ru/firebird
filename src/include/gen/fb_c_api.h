...
#define IStatement_PREPARE_REQUIRE_SEMICOLON ((unsigned) (0x80))
...
#define ICryptKeyCallback_NO_RETRY ((unsigned) (0))
#define ICryptKeyCallback_DO_RETRY ((unsigned) (1))
...
struct ICryptKeyCallbackVTable
{
	...
	unsigned (*afterAttach)(struct ICryptKeyCallback* self, struct IStatus* status, const char* dbName, const struct IStatus* attStatus);
	void (*dispose)(struct ICryptKeyCallback* self);
};
...
CLOOP_EXTERN_C unsigned ICryptKeyCallback_afterAttach(struct ICryptKeyCallback* self, struct IStatus* status, const char* dbName, const struct IStatus* attStatus);
CLOOP_EXTERN_C void ICryptKeyCallback_dispose(struct ICryptKeyCallback* self);
