...
// JSON constants used in the parse.y
enum JsonClause {
	JSON_UNDEFINED = 0,
	JSON_ERROR_ON_EMPTY = 1,
	JSON_NULL_ON_EMPTY = 2,
	JSON_DEFAULT_ON_EMPTY = 3,
	JSON_EMPTY_ARRAY_ON_EMPTY = 4,
	JSON_EMPTY_OBJECT_ON_EMPTY = 5,
	JSON_ERROR_ON_ERROR = 6,
	JSON_NULL_ON_ERROR = 7,
	JSON_DEFAULT_ON_ERROR = 8,
	JSON_EMPTY_ARRAY_ON_ERROR = 9,
	JSON_EMPTY_OBJECT_ON_ERROR = 10,
	JSON_FALSE_ON_ERROR = 11,
	JSON_TRUE_ON_ERROR = 12,
	JSON_OMIT = 13,
	JSON_KEEP = 14,
	JSON_WITHOUT_ARRAY = 15,
	JSON_WITH_CONDITIONAL_ARRAY = 16,
	JSON_WITH_UNCONDITIONAL_ARRAY = 17,
	JSON_RETURNING = 18,
	JSON_WITH_UNIQUE_KEYS = 19,
	JSON_WITHOUT_UNIQUE_KEYS = 20,
	JSON_NULL_ON_NULL = 21,
	JSON_ABSENT_ON_NULL = 22,
	JSON_UNKNOWN_ON_ERROR = 23,
	JSON_REPRESENTATION_JSON = 24,
	JSON_REPRESENTATION_SQL = 25
};
